...
00000000004010f4 <phase_6>:
  4010f4:	41 56                	push   %r14 ;callee side saving
  4010f6:	41 55                	push   %r13
  4010f8:	41 54                	push   %r12
  4010fa:	55                   	push   %rbp
  4010fb:	53                   	push   %rbx
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp ; why 60?
  401100:	49 89 e5             	mov    %rsp,%r13
  401103:	48 89 e6             	mov    %rsp,%rsi ;2nd argument
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>
  40110b:	49 89 e6             	mov    %rsp,%r14 ;rsp, rbp, r13, r14 6 integers
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d ;r12 a counter
  ; loop to ensure every number <= 6 and != each other
  401114:	4c 89 ed             	mov    %r13,%rbp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax ; first number!
  40111b:	83 e8 01             	sub    $0x1,%eax 
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34> ; every number <= 6, else explode
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f> ; r12 != 6, do 
  401132:	44 89 e3             	mov    %r12d,%ebx
  ; ---> loop to ensure number i!= rest of numbers
  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax ; eax: second value
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> ; jump if second value != fist value
  ...
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi ; rsi = rsp + 24 (after actual 7 - i)
  401158:	4c 89 f0             	mov    %r14,%rax ; rax = rsp
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx ; ecx = 7
  ; loop for i in numbers, number = 7 - number, 
  401160:	89 ca                	mov    %ecx,%edx ; edx, ecx = constant 7
  401162:	2b 10                	sub    (%rax),%edx ; edx -= (i th number)
  401164:	89 10                	mov    %edx,(%rax) ; i th number = end
  ...
  ; loop
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx ; 0x6032d8 + i*16, could not exceed 5
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax #
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  ; loop end
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  ; ---> loop start, from the secocnd number find the number that is greater than 1 | less than 6
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) ; write 32 @ rsp + 32 + i * 2
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi ; rsi is a counter used for 6 times
  401195:	74 14                	je     4011ab <phase_6+0xb7> ; jump out condition
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx ; rsi / 4 th number
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> ; if ecx <= 1, loop to next number
  ; ---> loop end
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>
  ; 1: 6304464, 2: 6304480, 3: 6304496, 4: 6304512, 5: 6304528, 6: 6304544

  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax ; +40
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi ; +80
  4011ba:	48 89 d9             	mov    %rbx,%rcx       ; rsp + 32
  ;loop start: this will loop for 5 times
...
; int read_six_numbers (char* input, char* destination) -> number of success
; char * input -> rdi
; char * dest  -> rsi
000000000040145c <read_six_numbers>:
  ...
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi  ;2nd string literal %d %d %d %d %d %d
  401485:	b8 00 00 00 00       	mov    $0x0,%eax       ;1st rdi is the same as caller
